    ...
    <div>
      ...
      <div className="glass rounded-xl p-8 max-w-4xl mx-auto">
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-2 px-6 py-4 bg-brand-500 hover:bg-brand-600 text-white rounded-lg font-semibold transition-all hover-lift mb-3"
        >
          Get Quote
        ...
        <div className="mb-6 p-3 bg-yellow-500/10 border border-yellow-500/20 rounded-lg">
          <div className="text-xs text-yellow-300 text-center">
            <strong>Note:</strong> Live crypto demo coming soon. MoonPay sandbox setup is more involved than fiat providers.
          </div>
        </div>
